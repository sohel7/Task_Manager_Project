...
class CompletedItemCard extends StatefulWidget {
  const CompletedItemCard({super.key, required this.task, required this.onStatusChange, required this.showProgress});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Chip(label: Text("completed",style: TextStyle(color: Colors.white),),backgroundColor: Colors.blue,),
                Wrap(
                  children: [
