...
class CancleItemCard extends StatefulWidget {
  const CancleItemCard({super.key, required this.task, required this.onStatusChange, required this.showProgress});
  final Task task;
  final VoidCallback onStatusChange;
  final Function(bool) showProgress;

  @override
  State<CancleItemCard> createState() => _CancleItemCardState();
}

class _CancleItemCardState extends State<CancleItemCard> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Chip(label: Text("Cancle",style: TextStyle(color: Colors.white),),backgroundColor: Colors.blue,),
                Wrap(
                  children: [
